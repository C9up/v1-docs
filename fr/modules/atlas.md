...
Atlas est l'ORM Data Mapper de Ream. Les entités sont de pures classes TypeScript décorées avec des métadonnées. Les requêtes sont compilées en SQL via Rust grâce à NAPI. Les événements de domaine s'accumulent sur les entités et sont envoyés à Pulsar après une sauvegarde réussie.
...
- [Pulsar (Événements)](/fr/modules/pulsar) — Envoyer les événements de domaine après la sauvegarde
