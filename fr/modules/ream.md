...
Ream (`@c9up/ream`) est le noyau du framework: bootstrap applicatif, IoC, providers, serveur HTTP, pipeline middleware, erreurs, lifecycle et orchestration des modules (`atlas`, `pulsar`, `rune`, `warden`, `spectrum`, etc.).
