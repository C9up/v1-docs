...
| `@c9up/pulsar` | Bus d'événements — pub/sub natif Rust via NAPI |
...
### Bus d'événements Pulsar

`@c9up/pulsar` fournit un bus d'événements publish/subscribe typé, adossé à un coeur Rust. La couche Rust gère la boucle de dispatch ; TypeScript s'abonne et émet avec une inférence de types complète.
