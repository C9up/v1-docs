          ...
          '/en/guide/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Authorization', link: '/en/guide/authorization' },
                { text: 'Console Commands', link: '/en/guide/console-commands' },
          ...
          '/en/modules/': [
            {
              ...
              items: [
                ...
                { text: 'Eclipse (Locks)', link: '/en/modules/eclipse' },
                { text: 'Eon (Time series)', link: '/en/modules/eon' },
                { text: 'Helix (Testing)', link: '/en/modules/helix' },
                { text: 'Helix plugin (ream bridge)', link: '/en/modules/helix-plugin-ream' },
                { text: 'Inker (Templates)', link: '/en/modules/inker' },
                { text: 'Nebula (Components)', link: '/en/modules/nebula' },
                { text: 'Nova (Notifications)', link: '/en/modules/nova' },
                { text: 'Parsec (Metrics)', link: '/en/modules/parsec' },
                { text: 'Photon (Frontend)', link: '/en/modules/photon' },
                { text: 'Prism (Images)', link: '/en/modules/prism' },
                { text: 'Quasar (Redis)', link: '/en/modules/quasar' },
                { text: 'Atom (Decimal)', link: '/en/modules/atom' },
                { text: 'Event Bus (ream core)', link: '/en/ream/events' },
                { text: 'Ream (Core)', link: '/en/ream/' },
                { text: 'Ream CLI', link: '/en/modules/ream-cli' },
                { text: 'Ream MCP (agents)', link: '/en/modules/ream-mcp' },
                ...
                { text: 'Lumen (Terminal output)', link: '/en/modules/lumen' },
                { text: 'Station (Admin)', link: '/en/modules/station' },
              { text: 'Transit (SSO)', link: '/en/modules/transit' },
                { text: 'Visa (OAuth 2.1 server)', link: '/en/modules/visa' },
                { text: 'Tailwind CSS', link: '/en/modules/tailwind' },
                { text: 'Vellum (PDF)', link: '/en/modules/vellum' },
          ...
          '/en/ream/': [
            {
              ...
              items: [
                ...
                { text: 'Task Scheduling', link: '/en/ream/scheduling' },
          ...
          '/fr/guide/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Autorisation', link: '/fr/guide/authorization' },
                { text: 'Commandes console', link: '/fr/guide/console-commands' },
          ...
          '/fr/modules/': [
            {
              ...
              items: [
                ...
                { text: 'Eclipse (Verrous)', link: '/fr/modules/eclipse' },
                { text: 'Eon (Séries temporelles)', link: '/fr/modules/eon' },
                { text: 'Helix (Testing)', link: '/fr/modules/helix' },
                { text: 'Helix plugin (pont ream)', link: '/fr/modules/helix-plugin-ream' },
                { text: 'Inker (Templates)', link: '/fr/modules/inker' },
                { text: 'Nebula (Composants)', link: '/fr/modules/nebula' },
                { text: 'Nova (Notifications)', link: '/fr/modules/nova' },
                { text: 'Parsec (Métriques)', link: '/fr/modules/parsec' },
                { text: 'Photon (Frontend)', link: '/fr/modules/photon' },
                { text: 'Prism (Images)', link: '/fr/modules/prism' },
                { text: 'Quasar (Redis)', link: '/fr/modules/quasar' },
                { text: 'Atom (Decimal)', link: '/fr/modules/atom' },
                { text: 'Event bus (core ream)', link: '/fr/ream/events' },
                { text: 'Ream (Core)', link: '/fr/ream/' },
                { text: 'Ream CLI', link: '/fr/modules/ream-cli' },
                { text: 'Ream MCP (agents)', link: '/fr/modules/ream-mcp' },
                ...
                { text: 'Lumen (Sortie terminal)', link: '/fr/modules/lumen' },
                { text: 'Station (Admin)', link: '/fr/modules/station' },
                { text: 'Transit (SSO)', link: '/fr/modules/transit' },
                { text: 'Visa (serveur OAuth 2.1)', link: '/fr/modules/visa' },
                { text: 'Tailwind CSS', link: '/fr/modules/tailwind' },
                { text: 'Vellum (PDF)', link: '/fr/modules/vellum' },
          ...
          '/fr/ream/': [
            {
              ...
              items: [
                ...
                { text: 'Planification de tâches', link: '/fr/ream/scheduling' },
