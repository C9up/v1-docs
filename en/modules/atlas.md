...
Atlas is Ream's Data Mapper ORM. Entities are pure TypeScript classes decorated with metadata. Queries compile to SQL through Rust via NAPI. Domain events accumulate on entities and dispatch to Pulsar after a successful save.
...
- [Pulsar (Events)](/en/modules/pulsar) — Dispatch domain events after save
