...
| `@c9up/transit` | Federated sign-in — OpenID Connect, OAuth1 / OAuth2 providers |
...
Part of ream core ([`@c9up/ream/events`](/en/ream/events)): a typed publish/subscribe event bus backed by a Rust core. The Rust layer handles the dispatch loop; TypeScript subscribes and emits with full type inference.
